...
class CoachAgent:
    ...
    def _generate_gemini_feedback(self, reps_telemetry: list[dict], video_path: str = None) -> dict:
        ...
        5. Generate a highly detailed and descriptive `veo_coaching_prompt` to guide a video generation model (like Google Veo) to create a 5-second video.
           - Visually inspect the attached video file to identify the user's gender, ethnicity, approximate age, clothing (e.g., color and style of t-shirt, shorts), hair color/style, and physical features.
           - Incorporate these visual details organically into the prompt's description of the coach (e.g., 'A professional athletic male coach of [ethnicity] in his [age range] with [hair style], wearing a [description of clothes]...'), ensuring that the coach generated by Veo closely matches the user's physical appearance and attire in the original video for high-fidelity identity consistency.
