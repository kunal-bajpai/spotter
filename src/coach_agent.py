...
class CoachAgent:
    ...
    def _generate_fallback_feedback(self, reps_telemetry: list[dict]) -> dict:
        ...
        fallback_veo_prompt = f"A high-fidelity video of a professional strength coach in a gym showing how to squat properly. The coach matches the following description: {fallback_person_desc}. "
